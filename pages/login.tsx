...
const Login: NextPage = () => {
    ...
    return (
        ...
        <div className={` w-sceen h-screen flex flex-col bg-bg justify-center items-center`}>
            <form className=' md:w-[350px] md:h-auto h-full w-full flex flex-col justify-center items-center bg-white p-5 rounded-md shadow-md text-base' onSubmit={(e) => { e.preventDefault(); signInWithAccount() }}>
                ...
                <div className='mb-6 w-full text-right text-blue-600 hover:cursor-pointer' onClick={goToReset}>Forgot your password?</div>
                <Button className='mb-1' fullWidth variant='contained' type='submit'>Sign in</Button>
                <div className='mb-1 text-lg'>or</div>
                <div className='flex flex-row w-full mb-6 p-2 bg-white shadow-md rounded-md border border-solid border-slate-200 items-center justify-center hover:cursor-pointer' onClick={signInWithGoogle}>
